//
//  NewDomainBlockViewController.swift
//  mastodon
//
...
class NewDomainBlockViewController: UIViewController, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        titleV.text = "Add Domain Block".localized
    ...
    @objc func didTouchUpInsideTootButton(_ sender: AnyObject) {
        ...
        let request = DomainBlocks.block(domain: self.textView.text)
