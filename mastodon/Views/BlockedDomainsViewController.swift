//
//  BlockedDomainsViewController.swift
//  mastodon
//
...
class BlockedDomainsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SKPhotoBrowserDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(self.refreshdomain), name: NSNotification.Name(rawValue: "refreshdomain"), object: nil)
        ...
        self.tableView.register(DomainsCell.self, forCellReuseIdentifier: "DomainsCell")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if self.currentTags.count == 0 {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "DomainsCell", for: indexPath) as! DomainsCell
            //            cell.delegate = self
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Alertift.actionSheet(title: nil, message: nil)
            ...
            .action(.default("Remove Block".localized), image: UIImage(named: "block")) { (action, ind) in
                ...
                statusAlert.title = "Removed Block".localized
                statusAlert.contentColor = Colours.grayDark
                statusAlert.message = self.currentTags[indexPath.row]
                ...
                let request = DomainBlocks.unblock(domain: self.currentTags[indexPath.row])
                StoreStruct.client.run(request) { (statuses) in
                    NotificationCenter.default.post(name: Notification.Name(rawValue: "refreshdomain"), object: nil)
                }
