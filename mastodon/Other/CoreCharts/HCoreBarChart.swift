...
//        }
        ...
        drawTitle(xPos: xPos, yPos: yPos, title: entry.barTitle, color: Colours.grayDark)

        drawTextValue(barWidth: barWidth, yPos: yPos, textValue: entry.barHeightText, color: Colours.grayDark)
    ...
    private func drawTextValue(barWidth: CGFloat, yPos: CGFloat, textValue: String, color: UIColor) {
        ...
        let font = UIFont.boldSystemFont(ofSize: valueFontSize)
