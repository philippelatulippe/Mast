...
class FullDateCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        contentView.backgroundColor = Colours.white3
    ...
    override var isSelected: Bool {
        didSet {
            ...
            contentView.backgroundColor = isSelected == true ? highlightColor : Colours.white3
    ...
    func populateItem(date: Date, highlightColor: UIColor, darkColor: UIColor, locale: Locale) {
        ...
        contentView.backgroundColor = isSelected == true ? highlightColor : Colours.grayLight2
    }
